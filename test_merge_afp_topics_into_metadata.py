...
def test_deduplicate_topics_keeps_richer_and_later_rows():
    rows = [
        {"id": "Alpha", "topic1": "Computer science", "topic2": "", "topic3": "", "published_year": "2023"},
        {"id": "Alpha", "topic1": "Computer science", "topic2": "Algorithms", "topic3": "", "published_year": "2024"},
        {
            "id": "Alpha",
        ...
        {"id": "Beta", "topic1": "Logic", "topic2": "", "topic3": "", "published_year": "2020"},
        {"id": "Beta", "topic1": "Mathematics", "topic2": "", "topic3": "", "published_year": "2021"},
    ]
...
def test_merge_topic_columns_adds_domain_clusters_and_published_year():
    metadata_rows = [
        {"id": "Alpha", "title": "Alpha entry", "published_year": ""},
        {"id": "Gamma", "title": "Gamma entry", "published_year": "existing"},
    ]
    topics_by_id = {
        "Alpha": {
            "id": "Alpha",
